...
public class UserAddedMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3801029320519663619L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAddedMessage\",\"namespace\":\"com.popug.accounting.messages\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"publicId\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"role\",\"type\":\"string\"}]}");
   ...
   */
  public static com.popug.accounting.messages.UserAddedMessage.Builder newBuilder() {
    return new com.popug.accounting.messages.UserAddedMessage.Builder();
  }
   ...
   * @return A new UserAddedMessage RecordBuilder
   */
  public static com.popug.accounting.messages.UserAddedMessage.Builder newBuilder(com.popug.accounting.messages.UserAddedMessage.Builder other) {
    if (other == null) {
      return new com.popug.accounting.messages.UserAddedMessage.Builder();
    } else {
      return new com.popug.accounting.messages.UserAddedMessage.Builder(other);
    }
  }
   ...
   * @return A new UserAddedMessage RecordBuilder
   */
  public static com.popug.accounting.messages.UserAddedMessage.Builder newBuilder(com.popug.accounting.messages.UserAddedMessage other) {
    if (other == null) {
      return new com.popug.accounting.messages.UserAddedMessage.Builder();
    } else {
      return new com.popug.accounting.messages.UserAddedMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAddedMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.popug.accounting.messages.UserAddedMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.popug.accounting.messages.UserAddedMessage other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder setPublicId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder clearPublicId() {
      publicId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder setRole(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.UserAddedMessage.Builder clearRole() {
      role = null;
