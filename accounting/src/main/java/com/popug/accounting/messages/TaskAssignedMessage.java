...
public class TaskAssignedMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4540708256754712784L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TaskAssignedMessage\",\"namespace\":\"com.popug.accounting.messages\",\"fields\":[{\"name\":\"userPublicId\",\"type\":\"string\"},{\"name\":\"taskPublicId\",\"type\":\"string\"}]}");
   ...
   */
  public static com.popug.accounting.messages.TaskAssignedMessage.Builder newBuilder() {
    return new com.popug.accounting.messages.TaskAssignedMessage.Builder();
  }
   ...
   * @return A new TaskAssignedMessage RecordBuilder
   */
  public static com.popug.accounting.messages.TaskAssignedMessage.Builder newBuilder(com.popug.accounting.messages.TaskAssignedMessage.Builder other) {
    if (other == null) {
      return new com.popug.accounting.messages.TaskAssignedMessage.Builder();
    } else {
      return new com.popug.accounting.messages.TaskAssignedMessage.Builder(other);
    }
  }
   ...
   * @return A new TaskAssignedMessage RecordBuilder
   */
  public static com.popug.accounting.messages.TaskAssignedMessage.Builder newBuilder(com.popug.accounting.messages.TaskAssignedMessage other) {
    if (other == null) {
      return new com.popug.accounting.messages.TaskAssignedMessage.Builder();
    } else {
      return new com.popug.accounting.messages.TaskAssignedMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TaskAssignedMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.popug.accounting.messages.TaskAssignedMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.popug.accounting.messages.TaskAssignedMessage other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.userPublicId)) {
        this.userPublicId = data().deepCopy(fields()[0].schema(), other.userPublicId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.TaskAssignedMessage.Builder setUserPublicId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.TaskAssignedMessage.Builder clearUserPublicId() {
      userPublicId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.TaskAssignedMessage.Builder setTaskPublicId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.popug.accounting.messages.TaskAssignedMessage.Builder clearTaskPublicId() {
      taskPublicId = null;
